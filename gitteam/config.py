...
def default_labels() -> list[Label]:
    return [
        ...
        Label("chore", "cfd3d7", "Maintenance, tooling, dependencies"),
        Label("refactor", "fbca04", "Code change that neither fixes a bug nor adds a feature"),
        ...
        Label("priority: high", "b60205", "Must be handled first"),
        Label("priority: medium", "fbca04", "Normal priority"),
        Label("priority: low", "0e8a16", "Nice to have"),
        Label("status: blocked", "e11d21", "Blocked by another issue or external dependency"),
        Label("breaking-change", "b60205", "Introduces a backwards-incompatible change"),
